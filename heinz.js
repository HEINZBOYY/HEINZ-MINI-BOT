...
const BOT_NAME = process.env.BOT_NAME || "ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׁׅ֬ ᴍɪׁׁׁׅׅׅ݊ɴɪׁׁׁׅׅׅ ʙᴏׅׅᴛׁׅ ";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "*ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ᴍׁׅ֪݊ɪׁׁׅׅׅ݊ɴɪׁׁׅׅׅ ֮ʙᴏׁׅׅᴛׁׅ֮ ֮ʙׁʏ ׅ֮ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ֮ʙׁᴏׁׅׅʏׅ֮*";
const DEV = process.env.DEV || ' ׅ֮ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ֮ʙׁᴏׁׅׅʏׅ֮';
        ...
        if (from.endsWith('@newsletter')) {
            ...
            switch (commandName) {
                case 'ping':
                    ...
                    const details = `⚡ *${BOT_NAME} ׅsᴘᴇׁׅܻ݊ᴇׁׅܻ݊ᴅׁׅ݊ ᴄׁ֒ʜׁׅ֮ᴇׁׅܻ݊ᴄׁ֒ᴋׁׅ* ⚡
                    
⏱️ ʀᴇsᴘᴏɴsᴇ ᴛɪᴍᴇ: *${responseTime.toFixed(2)}s* ⚡
👤 ᴏᴡɴᴇʀ: *${OWNER_NAME}*`;
        ...
        switch (commandName) {
            ...
            case 'speed':
                ...
                const details = `✨ *ʜᴇɪɴᴢ ᴍɪɴɪ ʙᴏᴛ - sᴘᴇᴇᴅ ᴄʜᴇᴄᴋ* ✨
...
🤖 ʙᴏᴛ : *${BOT_NAME}*`;
                ...
                await conn.sendMessage(from, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            title: "ʜᴇɪɴᴢ ᴍɪɴɪ ʙᴏᴛ - sᴘᴇᴇᴅ ᴛᴇsᴛ ",
            ...
            case 'heinz':  
                ...
                await conn.sendMessage(from, {  
                    ...
                    contextInfo: {  
                        ...
                        externalAdReply: {  
                            title: "🦄 ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׁׅ֬ ᴍɪׁׁׁׅׅׅ݊ɴɪׁׁׁׅׅׅ ʙᴏׅׅᴛׁׅ ᴍׅ֪݊ᴇׁׅܻ݊݊ɴᴜ 🦄ׁׅ",  
                            body: `${BOT_NAME} - ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs`,  
                            thumbnailUrl: MENU_IMAGE_URL,  
                            sourceUrl: REPO_LINK,  
                            mediaType: 1,  
                            renderLargerThumbnail: true  
...
│ 🔮 ʙᴏᴛ :  ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׁׅ֬ ʙᴏׅׅᴛׁׅ 
│ 👤 ᴜsᴇʀ :  ${sessionId}
│ 🧩 ᴏᴡɴᴇʀ :   ׅ֮ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ֮ʙׁᴏׁׅׅʏׅ֮
...
│  👋 ʜᴇʏ *${name}*
│  🎉 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍɪɴɪ 
│  🦄 ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ᴍׁׅ֪݊ɪׁׁׅׅׅ݊ɴɪׁׁׅׅׅ ֮ʙᴏׁׅׅᴛׁׅ
│  📌 ᴘʀᴇ́ғɪx : ${PREFIX}
│
╰────────•••────────❆
                        `;
                        ...
                        await conn.sendMessage(userJid, { 
                            ...
                            contextInfo: {
                                ...
                                externalAdReply: {
                                    ...
                                    body: `ʜׅ֮ᴇׁׅܻ݊ɪׁׁׁׅׅׅ݊ɴᴢׅ֬ ᴍׁׅ֪݊ɪׁׁׅׅׅ݊ɴɪׁׁׅׅׅ ֮ʙᴏׁׅׅᴛׁׅ֮ ֮ʙׁʏ ${OWNER_NAME}`,
                                    thumbnailUrl: MENU_IMAGE_URL,
                                    mediaType: 1,
                                    renderLargerThumbnail: true
                                }
